...
export default class MatchaListItem extends Component {
  ...
  render() {
    ...
    let img_url = "./img/" +  this.props.image
    return (
      <div className="col-sm-3" style={{"marginBottom":20}}>
        <div className="row">
          <div>
            <img src={img_url} alt={this.props.title} ref="cg_image" style={{width:200, height:100}} onClick={() =>this.props.onMarkerClick(this.getMarker(this.props.title))}></img>
          </div>
          <div>
